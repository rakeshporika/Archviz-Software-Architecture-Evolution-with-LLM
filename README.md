...
2. Add it to the .env file (which you have to CREATE in following manner)

   * **root_folder/.env**

     ```powershell
     # Input without inverted commas
     OPENAI_API_KEY "sk-yourkeyhere"
     OPENAI_MODEL="gpt-4o-mini"
     ```

3. ⚠️ **Usage note:** Each run uses API credits. Ensure your OpenAI account has funds before using the Insights tab go to your billing tab to check it.
